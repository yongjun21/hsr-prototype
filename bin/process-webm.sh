...
function process {
  ...
  then
    ...
    ffmpeg -i raw/mobile/$1.webm -c:v libvpx-vp9 -b:v 0 -crf 42 -g 30 -an -threads 7 -vf crop=486:864:0:120,eq=saturation=1.3:brightness=-0.01,unsharp=5:5:0.5:5:5:0.0 processed/mobile/$1.webm
  fi
}
